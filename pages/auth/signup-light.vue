                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="password-toggle">
                                <input class="form-control" :type="passwordType" id="signup-password" minlength="8" required autocomplete="off" />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="password-toggle">
                                <input class="form-control" :type="confirmPasswordType" id="signup-password-confirm" minlength="8" required autocomplete="off" />
                                <label class="password-toggle-btn" aria-label="Show/hide password">
